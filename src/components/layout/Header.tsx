...
export default function Header() {
  ...
  return (
    <>
      {/* Sale Banner */}
      <div className="bg-pink text-center py-3 px-4 relative overflow-hidden">
        <div
        ...
        <p className="text-white text-base font-bold relative z-10">
          It&apos;s an Art Party is for Sale! Please{" "}
          <Link
            href="/contact"
            className="underline hover:no-underline hover:text-gold transition-colors duration-300"
          >
            contact me here
          </Link>{" "}
          if interested.
